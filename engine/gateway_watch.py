...
``engine/watch_and_run.py`` is included because a watcher re-exec kills
the gateway child the same way a gateway-module edit does.
"""
...
# Normpath keys — gateway process modules plus the watcher entrypoint.
