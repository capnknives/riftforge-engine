...
ENGINE_COMMANDS = {
    ...
    "questions": (cmd_questions, "global player-help questions; bare questions shows recent lines"),
    "answers":   (cmd_answers,   "helper answers net; bare answers shows recent lines (helpers only)"),
    ...
    "reports":   (cmd_reports,   "GM: list tickets; reports show|comment <kind> <id>"),
    ...
    "commands":  (cmd_commands,  "compact verb list (hubs, not glued aliases); commands detail for full tips; commands <verb> for one"),
