...
ENGINE_COMMANDS = {
    ...
    "get":       (cmd_get,       "pick up an item (get <name>|all|all.<name>; get all.<name> from 2.backpack)"),
    ...
    "give":      (cmd_give,      "hand carried items to someone here (give <item>|5 <item> to <name>)"),
    "hand":      (cmd_give,      "hand carried items to someone here (give <item>|5 <item> to <name>)"),
    ...
    "group":     (cmd_group,     "party roster + merge + row (see 'help group')"),
    ...
    "afk":       (cmd_idlemode,  "alias: idlemode (see 'help idlemode')"),
    "setpass":   (
        cmd_setpass,
    ...
    "reports":   (cmd_reports,   "alias: gm reports -- staff ticket list (see 'help gm-reports')"),
