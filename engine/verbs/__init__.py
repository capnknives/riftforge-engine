...
ENGINE_COMMANDS = {
    ...
    "give":      (cmd_give,      "hand a carried item to someone here (give <item> to <name>)"),
    "hand":      (cmd_give,      "hand a carried item to someone here (give <item> to <name>)"),
    ...
    "tell":      (cmd_tell,      "private message someone anywhere; bare tell replays recent tells"),
    "whisper":   (cmd_tell,      "private message someone anywhere; bare tell replays recent tells"),
    ...
    "bugs":      (cmd_bugs,      "list your open bug reports (see 'help bug')"),
    "suggest":   (cmd_suggest,   "file a suggestion for staff (see 'help suggest')"),
    "ideas":     (cmd_ideas,     "list your open suggestions (see 'help suggest')"),
    "suggestions": (cmd_ideas,   "list your open suggestions (see 'help suggest')"),
